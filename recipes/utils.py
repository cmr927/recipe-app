from recipes.models import (
    Recipe,
    Ingredient,
)  # you need to connect parameters from recipes modeel
...
def get_chart(chart_type, data, **kwargs):
    ...
    if chart_type == "#1":
        ...
        plt.pie(
            difficulty_sizes["id"].values, labels=difficulty_sizes["difficulty"].values
        )
